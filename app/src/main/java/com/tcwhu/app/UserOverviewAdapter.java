...
import com.google.android.material.button.MaterialButton; // CRITICAL IMPORT
...
public class UserOverviewAdapter extends RecyclerView.Adapter<UserOverviewAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        MaterialButton buttonDynamicAction; // CHANGED FROM Button TO MaterialButton
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            // Must cast here to MaterialButton
        ...
        public void bind(final Student student, final OnActionListener listener) {
            ...
            textNickname.setText(student.getNickname());
            textStudentNumber.setText(student.getStudentNumber());

            // --- Status & Dynamic Button Logic ---
            if (student.isBanned()) {
                setStatus(Color.parseColor("#B71C1C"), "BANNED");
                // Corrected lambda signature (v -> listener.onUnban(student.getUserId()))
                ...
                setDynamicAction("REVIEW", R.drawable.ic_view, v -> {
                    // This action does not call a listener method
        ...
        // Corrected method to handle MaterialButton properties
        private void setDynamicAction(String text, int iconRes, View.OnClickListener clickListener, int color) {
            ...
            // This method requires a ColorStateList and is now called on MaterialButton
