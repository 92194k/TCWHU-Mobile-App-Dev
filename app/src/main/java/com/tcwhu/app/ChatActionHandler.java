...
// NOTE: Placeholder classes (Message, MessageOptionHandler, Report, ChatWindowCallbacks, ChatDataManager) are assumed to exist.
...
public class ChatActionHandler implements MessageOptionHandler {
    ...
    public ChatActionHandler(Context context, String currentUserId, String otherUserId, String chatId,
                             ChatDataManager dataManager, ChatWindowCallbacks callbacks) {
    ...
    public void showDeleteDialog() {
        new AlertDialog.Builder(context)
                ...
                .setMessage("This will clear your view of the chat history. The conversation will be permanently deleted only when the other user also deletes it.")
    ...
    private void reportUser(String reason) {
        ...
        //         .addOnFailureListener(e -> callbacks.showToast("Failed to report.", Toast.LENGTH_SHORT));
    }
    ...
    // --- Message Specific Options (Implementing MessageOptionHandler) ---
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton("Submit Report", (d, w) -> {
                    ...
                    if (!reason.isEmpty()) {
                        ...
                        callbacks.showToast("Reason required.", Toast.LENGTH_SHORT);
                    }
                })
                .setNegativeButton("Cancel", null)
                .show();
    ...
    private void deleteSingleMessage(Message message) {
        ...
        db.collection("chats").document(chatId)
                ...
                .addOnFailureListener(e -> callbacks.showToast("Failed to find message for deletion.", Toast.LENGTH_SHORT));
    }
